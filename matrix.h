...
Ignores the controls characters (stats from ' ' or 0x20 at index 0)
...
static const unsigned char char_data[95][5] PROGMEM = {
    ...
    // Special Characters Part 2 (ASCII 0x3A-0x40)
    ...
    // Uppercase Alphabet (ASCII 0x41-0x5A)
    ...
    // Special Characters Part 3 (ASCII 0x5B-0x60)
    {0x00, 0x7F, 0x41, 0x41, 0x00}, // [
    {0x20, 0x10, 0x08, 0x04, 0x02}, // \ (extra notes here to back up the escaped character)
    {0x00, 0x41, 0x41, 0x7F, 0x00}, // ]
    {0x10, 0x20, 0x40, 0x20, 0x10}, // ^
    {0x01, 0x01, 0x01, 0x01, 0x01}, // _
    {0x00, 0x40, 0x20, 0x00, 0x00}, // `

    // Lowercase Alphabet (ASCII 0x61-0x7A)
    ...
    // Special Characters Part 4 (ASCII 0x7B-0x7E)
